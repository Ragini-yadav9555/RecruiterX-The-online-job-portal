        ...
        <div className="col-sm-10">
            <div className="row">
                ...
                <div className="row mb-4">
                    ...
                    {errors.jobLocation?.message && <span  className='error_msg'>{errors.jobLocation?.message}</span>}
                </div>
                <div className="row mb-4">
                    <input  className="form-control " 
                    ...
                    />
                     {errors.jobPreference?.message && <span  className='error_msg'>{errors.jobPreference?.message}</span>}
                </div>
                <div className="row mb-4">
                    <input  className="form-control " 
                    type="file"
