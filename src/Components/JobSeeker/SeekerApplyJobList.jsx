                        ...
                        return (
                            ...
                            <div className="row d-flex justify-content-center align-items-center">
                                ...
                                <div className="col-md-3 d-flex justify-content-start flex-column my-3">
                                    ...
                                    <div className='postedjob_p2 mb-2'>Name:<span className='postedjob_p1'> {el.name}</span></div>
                                    <div className='postedjob_p2 mb-2'>JobType:<span className='postedjob_p1'> {el.jobType}</span></div>
                                </div>
