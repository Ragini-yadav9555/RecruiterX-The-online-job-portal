                        ...
                        <div className="col-12 col-md-6 col-lg-4 seeker_list my-2 mx-2" key={index}>
                            <div className="card border border-none p-2 h-100">
                                <div className="text-center">
                                    <img className="seeke_img img-fluid rounded-circle" src={`http://localhost:9000/upload/${item.img}`} alt={item.name} style={{ maxWidth: '100px', height: '100px' }} />
                                </div>
                                ...
                                <table className="table table-borderless mt-3">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td className="text-left">{item.jobPreference}</td>
                                        </tr>
                                        <tr>
                                            <div className="row">
                                ...
                                <div className="text-center mt-auto">
                                    {/* <button className=" seeker_btn ">Block</button> */}
                                </div>
                            </div>
                        </div>
                    ))
